                ...
                <div key={message.id} className="group">
                  ...
                  >
                    ...
                    <div className="flex-shrink-0">
                      <div
                        className={`w-8 h-8 rounded-md flex items-center justify-center text-[13px] font-medium ${
                          message.role === "user"
                          ...
                          <div className="p-3">
                            ...
                            <div className="space-y-1">
                              {message.commands.map((command, index) => (
                                <code
                                  key={index}
                                  className="block font-mono text-[12px] bg-black/20 text-white/70 px-2 py-1 rounded"
                                >
                                  {command}
                                </code>
                              ))}
          ...
          <div className="px-4 py-3">
            <form onSubmit={handleSubmit} className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 h-8 w-8 flex items-center justify-center rounded-md bg-[#1D1D1D] text-white/80 hover:bg-[#2D2D2D] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#1D1D1D] transition-colors"
                style={{ marginTop: '-9px' }}
              >
                {isLoading ? (
                  <svg
